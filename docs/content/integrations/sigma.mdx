...
By default, Dagster will generate asset keys for each Power BI asset based on its type and name and populate default metadata. You can further customize asset properties by using <PyObject object="Definitions" method="map_asset_specs" />, which applies a function of your choosing to each asset.
