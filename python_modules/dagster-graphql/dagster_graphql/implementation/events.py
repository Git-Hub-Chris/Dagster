...
def from_dagster_event_record(event_record: EventLogEntry, pipeline_name: str) -> Any:
    ...
    elif dagster_event.event_type == DagsterEventType.PLANNED_ASSET_MATERIALIZATION_FAILURE:
        return GraphenePlannedAssetMaterializationFailureEvent(event=event_record)
    elif dagster_event.event_type == DagsterEventType.PLANNED_ASSET_MATERIALIZATION_SKIPPED:
        return GraphenePlannedAssetMaterializationSkippedEvent(event=event_record)
